                    ...
                    <div
                        ...
                        <div class="billing checkout_box">
                            ...
                            <div class="checkout_form_container">
                                <form method="POST" action="{{ url('beranda/pembeli/update/'.$data['id_pembeli']) }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="kode_pos" value="{{ $data['tempat_lahir'] }}"  name="tempat_lahir" class="checkout_input"
                                            required="required">
                                    </div>
                                    <div>

                                        <label for="checkout_zipcode">Tgl. Lahir</label>
                                        <input type="date" id="kode_pos" value="{{ $data['tgl_lahir'] }}" name="tgl_lahir" class="checkout_input"
                                            required="required">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="kode_pos" value="{{ $data['no_hp'] }}" name="no_hp" class="checkout_input"
                                            required="required">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <button type="submit" class="checkout_button trans_200">Ubah</button>
                                    </div>
                                </form>
                            </div>
                        </div>
