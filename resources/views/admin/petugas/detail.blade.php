...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Detail Data Produk</h6>
        </div>
        <div class="card-body">
            <form class="form-horizontal" method="POST" action="{{ url('admin/produk/update/'.$data['id_produk']) }}"
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" disabled value="{{ $data['nama_produk'] }}" name="nama_produk" autofocus required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control" name="deskripsi" disabled required>{{ $data['deskripsi'] }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-3 control-label">Harga</label>
                        <div class="col-sm-12">
                            <input type="number" class="form-control" name="harga" disabled  value="{{ $data['harga'] }}"  required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-3 control-label">Berat</label>
                        <div class="col-sm-12">
                            <input type="number" class="form-control" name="berat" disabled  value="{{ $data['berat'] }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-3 control-label">Stok</label>
                        <div class="col-sm-12">
                            <input type="number" class="form-control" name="stok" disabled  value="{{ $data['stok'] }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="file" disabled  class="form-control" name="file">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-10">
                            <a href="{{ url('admin/produk/index/') }}" class="btn btn-danger">Kembali</a>
                        </div>
                    </div>
            </form>
        </div>
